...
class _DataVisualizationState extends State<DataVisualization> {
  ...
  String buttonText = "  upload a csv file";
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text("start visualizing your data with 10 different graphing methods",
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: Text.rich(
                              TextSpan(
                                children: [
                                  WidgetSpan(child: Icon(done ? Icons.download : Icons.upload_file, color: Colors.purple,), alignment: PlaceholderAlignment.middle),
                                  TextSpan(
                                    text: buttonText,
